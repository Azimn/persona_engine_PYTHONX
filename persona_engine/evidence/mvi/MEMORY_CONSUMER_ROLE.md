...
Smallest role projection preserving current causal + retrieval-trace continuity: `causal2_only`.  
...
| --- | ---: | --- | --- | --- | --- | --- | --- |
| full | 7 | True | qualified_response | True | True | True | True |
| causal2_only | 2 | True | qualified_response | True | True | True | True |
